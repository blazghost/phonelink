...
#   sshfs          mounts the phone's storage for the Photos window
pacman -S --needed --noconfirm kdeconnect scrcpy android-tools android-udev python-gobject gtk4 libadwaita gtk4-layer-shell sshfs
